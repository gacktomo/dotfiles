...
time ADET_USER_ID=test-user \
  ADET_PROJECT_ID=00000000-0000-0000-0000-000000000001 \
...
- SPEC_AGENT_VERSIONを0.0.1または0.0.2と指定することでagentバージョンを変更できる
...
| `~/Documents/adet/tenpla-core-ProjectSpecification-v2.json` | **v2 Spec 差分生成のベース** (`SPEC_SNAPSHOT_URL` で参照される既存Spec) |
